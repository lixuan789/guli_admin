      ...
      <section class="c-sort-box">
        <section class="c-s-dl">
            ...
            <dd class="c-s-dl-li">
              <ul class="clearfix">
                ...
                <li v-for="(subject,index) in subjectNestedList" :key="index" :class="{active:oneIndex==index}">
                  <a :title="subject.title" href="#" @click="getOne(subject.id,index)">{{ subject.title }}</a>
                </li>
              </ul>
            </dd>
          </dl>
          <dl>
            ...
            <dd class="c-s-dl-li">
              <ul class="clearfix">
                <li v-for="(sub,index) in subSubjectList" :key="index" :class="{active:twoIndex==index}">
                  <a :title="sub.title" href="#" @click="getTwo(sub.id,index)">{{ sub.title }}</a>
                </li>
              </ul>
            </dd>
          </dl>
  ...
  methods:{
    ...
    getOne(parentId,index){
      ...
      for (let i=0;i<this.subjectNestedList.length;i++){
        if (this.subjectNestedList[i].id===parentId){
