  ...
  <div class="app-container">
    ...
    <el-form :inline="true" class="demo-form-inline">
      ...
      <el-form-item label="添加时间">
        <el-date-picker
          v-model="teacherQueryVo.joinDateBegin"
          type="datetime"
          placeholder="选择开始时间"
      ...
      <el-form-item>
        <el-date-picker
          v-model="teacherQueryVo.joinDateEnd"
          type="datetime"
          placeholder="选择截止时间"
          value-format="yyyy-MM-dd HH:mm:ss"
          default-time="00:00:00"
...
export default {
  ...
  methods:{
    getList(page =1) {
      this.page=page
      teacher.listPage(this.page,this.limit,this.teacherQueryVo)
      .then(reponse=>{
        console.log(reponse)
        this.total=reponse.data.total
        this.res=reponse.data.rows
      })
      .catch(error=>{
        console.log(error)
      })
